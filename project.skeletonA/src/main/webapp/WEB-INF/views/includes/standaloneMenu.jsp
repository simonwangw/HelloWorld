...
<body>
	<!-- BEGIN SIDEBAR -->
		<div class="page-sidebar nav-collapse collapse" style="margin-left:0px;float:left;height:100%;width:271px;overflow-y:auto;">
			<!-- BEGIN SIDEBAR MENU -->        
			<ul class="page-sidebar-menu">
				...
				<li class="start ">
					<a href="index.html">
					<i class="icon-home"></i> 
					<span class="title">Dashboard Start Here</span>
					</a>
				</li>
				<li class="">
					<a href="javascript:;">
				...
				<li class="">
					...
					<ul class="sub-menu">
						<li >
							<a href="listData" target="view_frame">
							Form Layouts</a>
						</li>
						<li >
