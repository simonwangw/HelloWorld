	...
	<div class="header navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<img src="resources/media/image/menu-toggler.png" alt="" />
				</a>          
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown" id="header_inbox_bar">
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li>
								...
								<span class="photo"><img src="resources/media/image/avatar2.jpg" alt="" /></span>
								<span class="subject">
							...
							<li>
								<a href="inbox.html?a=view">
								<span class="photo"><img src="./resources/media/image/avatar3.jpg" alt="" /></span>
								<span class="subject">
							...
							<li>
								<a href="inbox.html?a=view">
								<span class="photo"><img src="./resources/media/image/avatar1.jpg" alt="" /></span>
								<span class="subject">
					...
					<li class="dropdown user">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						<img alt="" src="resources/media/image/avatar1_small.jpg" />
